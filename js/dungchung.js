	...
	<div class="top-nav group">
        <section>
            <ul class="top-nav-quicklink flexContain">
                <li><a href="index.html"><i class="fa fa-home"></i> <span> Trang chủ </span></a></li>
                <li><a href="tintuc.html"><i class="fa fa-newspaper-o"></i> <span> Tin tức </span></a></li>
                <li><a href="gioithieu.html"><i class="fa fa-info-circle"></i> <span> Giới thiệu </span></a></li>
                <li><a href="trungtambaohanh.html"><i class="fa fa-wrench"></i> <span> Bảo hành </span></a></li>
                <li><a href="lienhe.html"><i class="fa fa-phone"></i> <span> Liên hệ </span></a></li>
            </ul> <!-- End Quick link -->
        </section><!-- End Section -->
    </div><!-- End Top Nav  -->`);
}
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Phone Paradise</a> - All rights reserved © 2023 - Designed by
            <span style="color: #eee; font-weight: bold">group 16th</span></p>
    </div>`);
}
...
function addPlc() {
    ...
    <div class="plc">
        <section>
            <ul class="flexContain top-footer">
